...
export const en: NewsletterHubStrings = {
  ...
  testCenter: {
    ...
    summaryStats: '3 templates · 16 page states · 60s cooldown · 10/hr limit',
    ...
    samplePreview: 'Sample preview — select an edition above to preview real content',
    templateConfirm: 'Confirm',
    templateWelcome: 'Welcome',
    templateEdition: 'Edition',
    errorNoContent: 'This edition has no content yet',
    errorNotFound: 'Edition not found',
    errorForbidden: 'Insufficient permissions',
    errorHourlyLimit: 'Hourly limit reached (10/hr)',
    sampleBadge: 'sample',
