...
export function MonthCalendar({ slots, locale = 'en' }: MonthCalendarProps) {
  ...
  return (
    <div className="rounded-[10px] border border-gray-800 bg-gray-900 overflow-hidden">
      <div className="flex items-center justify-between border-b border-gray-800 px-4 py-2.5">
        <button onClick={prevMonth} className="flex h-7 w-7 items-center justify-center rounded-md text-gray-400 hover:bg-gray-800 hover:text-gray-200" aria-label="Previous month">
        ...
        <button onClick={nextMonth} className="flex h-7 w-7 items-center justify-center rounded-md text-gray-400 hover:bg-gray-800 hover:text-gray-200" aria-label="Next month">
