...
export function SocialCanvasEditor({
  ...
  const handleLoadTemplate = useCallback(async (_templateId: string) => {
    // Template loading is handled by the parent component which fetches
    // the full composition from the server action and calls replaceComposition
  }, [])
