...
export const MOCK_DRAFT_ITEMS = [
  {
    ...
    description: 'Gerado a partir da edição #043 do Thiago\'s Journal. Inclui resumo dos destaques e link direto.',
  ...
  },
  {
    ...
    description: 'Post automático para YouTube Community baseado no vídeo publicado. Convida a audiência a comentar.',
  ...
  },
  {
    ...
    description: 'Aprendi inglês brigando online — compartilhar no Facebook com trecho do post e link.',
...
export const MOCK_FEED_ITEMS: FeedItem[] = [
  ...
  },
  {
    id: 'mock-4',
    status: 'completed',
    title: 'Em 2009 eu xingava em inglês quebrado. Em 2017 tirei 91 no TOEFL sem nenhuma...',
    imageUrl: null,
    scheduledAt: null,
