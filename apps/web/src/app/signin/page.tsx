    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">ByThiagoFigueiredo</h1>
          <p className="text-gray-500 text-sm mt-1">Acesso à área administrativa</p>
        </div>

        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Entrar na sua conta</h2>

          {(error ?? (authError ? 'Erro na autenticação. Tente novamente.' : null)) && (
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 disabled:bg-gray-100 disabled:text-gray-400 py-3 rounded-lg font-medium transition mb-6"
          >
          ...
          <form onSubmit={onPasswordSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <Link href="/signin/forgot" className="text-sm text-blue-600 hover:underline">
                  Esqueci minha senha
                </Link>
              </div>
            </div>
