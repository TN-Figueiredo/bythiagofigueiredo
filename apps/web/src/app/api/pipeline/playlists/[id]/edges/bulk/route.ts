...
import { bulkCreateEdgesService } from '@/lib/pipeline/services/playlists'
...
export async function POST(
  ...
  try {
    const data = await bulkCreateEdgesService(authToServiceContext(auth), playlistId, parsed.data)
