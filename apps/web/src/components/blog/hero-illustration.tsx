...
function HeroConstellation({ dark, accent }: IllustrationProps) {
  ...
  return (
    ...
    >
      ...
      <g filter="url(#btf-shadow)" transform="translate(140, 80) rotate(-4)">
        ...
        <text x="10" y="68" style={{ fontFamily: "'JetBrains Mono', monospace" }} fontSize="7" fill={ink} opacity="0.6" letterSpacing="0.1em">VGL</text>
      </g>
      ...
      <g filter="url(#btf-shadow)" transform="translate(560, 90) rotate(5)">
        ...
        <text x="12" y="72" style={{ fontFamily: "'JetBrains Mono', monospace" }} fontSize="7" fill={ink} opacity="0.6" letterSpacing="0.1em">TNG</text>
      </g>
      ...
      <g transform="translate(400, 240)">
        ...
        <g filter="url(#btf-shadow)">
          ...
          <g style={{ fontFamily: "'Caveat', cursive" }} fontSize="12" fill={ink} opacity="0.9">
            <text x="18" y="-28">1 &middot; idea</text>
            <text x="18" y="-14">2 &middot; draft</text>
            <text x="18" y="0">3 &middot; publish</text>
            <text x="18" y="14">4 &middot; distribute</text>
            <text x="18" y="28">5 &middot; forget</text>
          </g>
      ...
      <g style={{ fontFamily: "'JetBrains Mono', monospace" }} fontSize="9" fill={ink} opacity="0.5" letterSpacing="0.1em">
        <text x="24" y="32">FIG. 1</text>
        <text x="24" y="44" opacity="0.7" fontSize="7">&mdash; a hub and its satellites</text>
      </g>
      <g style={{ fontFamily: "'JetBrains Mono', monospace" }} fontSize="9" fill={ink} opacity="0.5" letterSpacing="0.1em">
...
const HERO_ILLUSTRATIONS: Record<string, (props: IllustrationProps) => React.JSX.Element> = {
  constellation: HeroConstellation,
}

export function HeroIllustration({ kind, dark, accent }: Props) {
