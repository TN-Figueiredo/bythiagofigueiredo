  ...
  return (
    ...
    >
      ...
      >
        ...
        {pinned && (
          <div className="absolute -right-1 -top-1 z-20 rounded-full bg-amber-400 p-0.5 shadow-sm" aria-label="Pinned">
            <svg className="h-3 w-3 text-amber-900" viewBox="0 0 16 16" fill="currentColor">
