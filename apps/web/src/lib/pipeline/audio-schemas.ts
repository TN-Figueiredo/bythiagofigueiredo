...
export const AudioAssetCreateSchema = z.object({
  ...
  source: z.string().max(200).default('artlist'),
  ...
  tempo_feel: z.string().max(50).optional(),
  tags: z.array(z.string().max(50)).max(50).default([]),
  mood: z.array(z.string().max(50)).max(30).default([]),
  instruments: z.array(z.string().max(50)).max(30).default([]),
  use_cases: z.array(z.string().max(100)).max(30).default([]),
  reuse_scenarios: z.array(z.string().max(100)).max(30).default([]),
...
export const ImportItemSchema = z.object({
  ...
  rename_to: z.string().max(500).optional(),
