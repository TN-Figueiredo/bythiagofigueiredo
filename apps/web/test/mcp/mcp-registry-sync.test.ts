...
describe('MCP Registry Sync', () => {
  ...
  it('has exactly 23 unique MCP tools', () => {
  ...
  it('covers all registry endpoints', () => {
    ...
    // Sum: items(18) + playlists(13) + libraries(15) + research(26) + youtube(31) + utilities(11) + course(0) + links(5) = 119
    expect(mapped.length + unmapped.length).toBe(119)
  })
})
