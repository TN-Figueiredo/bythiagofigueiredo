...
const NAV = [
  ...
  { sec: "Content", items: [
    ...
    { id: "waitlists", label: "Waitlists", icon: "gift" },
...
const CORE = ["dashboard", "upnext", "schedule", "analytics", "notifications", "blog", "video", "research", "waitlists"];
const TITLES = {
  ...
  research: ["Research", null], video: ["Vídeos", null],
  waitlists: ["Waitlists", null],
};
const ACCENTS = {
...
/* ---------------- APP ---------------- */
function App() {
  const ROUTES = ["dashboard","upnext","schedule","analytics","notifications","blog","video","research","waitlists","notifPrefs"];
      ...
      <div className="main">
        ...
        <div className="content">
          <div className="content-inner">
            ...
            {route === "video" && <VideoView theme={theme} />}
            {route === "research" && <ResearchView />}
            {route === "waitlists" && <WaitlistsView go={go} state={dataState} />}
