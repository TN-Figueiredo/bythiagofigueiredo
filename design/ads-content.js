/*
 * ads-content.js — Patrocinadores mock e house ads
 * Mantém um catálogo de ads com diferentes formatos. Cada um tem
 * variações por slot (algumas funcionam melhor inline, outras como modal).
 *
 * Patrocinadores fictícios coerentes com público: dev/criador.
 *   1. RAILWAY GHOST — hosting indie (300x250, copy técnica)
 *   2. ENSAIOS DE OBSIDIAN — livro técnico (square, capa)
 *   3. CONVERTKIT (mock) — newsletter platform (banner)
 *
 * House ads (próprios):
 *   - newsletter (Caderno de Campo)
 *   - youtube (canal)
 *   - série em destaque
 */

window.AdsContent = (function () {
  // ---- Sponsors ----
  const sponsors = {
    railway: {
      id: "railway-ghost",
      ...
      label_en: "SPONSORED",
      brand: "Railway Ghost",
      brandColor: "#7B5BF7", // a calm purple, distinct from site orange
      headline_pt: "Deploy sem stress, do dev ao prod",
      headline_en: "Deploys that don't keep you up at night",
      body_pt: "Hosting feito por dois desenvolvedores cansados de Heroku. Postgres, Redis, e um CLI que não te odeia. 14 dias grátis.",
      body_en: "Hosting built by two devs tired of Heroku. Postgres, Redis, and a CLI that doesn't hate you. 14 days free.",
      ...
      // Decorative SVG mark for the ad
    ...
    obsidian: {
      ...
      brandColor: "#3B5A4A", // forest green
      ...
      body_pt: "São 12 ensaios curtos sobre como manter uma prática de escrita honesta quando ninguém te paga pra escrever. Edição em português, lançada esse mês.",
      body_en: "Twelve short essays on keeping an honest writing practice when nobody pays you to write. Portuguese edition, out this month.",
      cta_pt: "Comprar (R$ 39) →",
      cta_en: "Buy (US$ 9) →",
    ...
    convertkit: {
      ...
      label_en: "SPONSORED",
      brand: "Mailpond",
      brandColor: "#D4724B", // warm terracotta — close to brand but distinct
      headline_pt: "A plataforma de newsletter pra escritores que valorizam tipografia",
      headline_en: "A newsletter platform for writers who care about typography",
      body_pt: "Source Serif, Söhne, sua própria fonte custom. Sem templates plásticos. Lista de 1.000 grátis pra sempre.",
      body_en: "Source Serif, Söhne, your own custom font. No plastic templates. 1,000 subscribers free forever.",
  ...
  const houseAds = {
    newsletter: {
      ...
      body_pt: "Uma carta a cada 15 dias, com o que estou escrevendo, lendo, e construindo. 1.247 leitores. Sem spam, sem afiliados.",
      body_en: "A letter every 15 days with what I'm writing, reading, and building. 1,247 readers. No spam, no affiliates.",
    ...
    youtube: {
      ...
      body_pt: "Vídeos curtos sobre o que estou construindo. Esta semana: como o CMS gerencia vários sites com um post só.",
    ...
    relatedPost: {
      ...
      brandColor: "#7A8A4D",
      headline_pt: "Por que abandonei o Notion para escrever — e o que veio depois",
      headline_en: "Why I left Notion for writing — and what came next",
      body_pt: "Sobre fricção, atrito útil, e por que ferramentas \"perfeitas\" às vezes atrapalham. Ensaio de 12 minutos.",
      body_en: "On friction, useful resistance, and why \"perfect\" tools sometimes get in the way. A 12-minute essay.",
      cta_pt: "Ler o ensaio →",
