    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
      <div>
        ...
        <div style={{ display: "flex", gap: 18, alignItems: "flex-end", marginTop: 14 }}>
          <CarimboPhotoFull ink={ink} accent={accent} size={120} photoHref={window.__resources && window.__resources.photoPlaceholder}/>
          <CarimboPhotoSimplified ink={ink} accent={accent} size={64} photoHref={window.__resources && window.__resources.photoPlaceholder}/>
          <CarimboPhotoMark ink={ink} accent={accent} size={32} photoHref={window.__resources && window.__resources.photoPlaceholder}/>
        </div>
        <div style={{
