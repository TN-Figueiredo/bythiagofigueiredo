-- Fix social_publish_fair_batch: column order must match social_posts table definition
-- The previous migration (20260515400000) failed because the SELECT column order
-- didn't match the table's physical column order for `returns setof social_posts`.
