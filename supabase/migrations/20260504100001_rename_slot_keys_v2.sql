...
INSERT INTO public.ad_placeholders (slot_id, is_enabled, headline, body, cta_text, cta_url, image_url, dismiss_after_ms, app_id, updated_at)
SELECT
  CASE slot_id
  ...
  END,
  is_enabled, headline, body, cta_text, cta_url, image_url, dismiss_after_ms, app_id, now()
...
-- 3. ad_slot_metrics (slot_key is in UNIQUE constraint but not PK — update in-place)
UPDATE public.ad_slot_metrics SET slot_key = 'post:top:banner'       WHERE slot_key = 'banner_top';
UPDATE public.ad_slot_metrics SET slot_key = 'post:rail:anchor-left' WHERE slot_key = 'rail_left';
UPDATE public.ad_slot_metrics SET slot_key = 'post:rail:anchor'      WHERE slot_key = 'rail_right';
UPDATE public.ad_slot_metrics SET slot_key = 'post:body:bookmark'    WHERE slot_key = 'inline_mid';
UPDATE public.ad_slot_metrics SET slot_key = 'post:footer:coda'      WHERE slot_key = 'block_bottom';
